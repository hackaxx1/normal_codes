...
data = [
    {"ad": "Proje 1",
     ...
     "basvuru_acik": True,
     "detay": "Proje 1 için detaylı açıklamalar burada yer alır."},
    ...
    {"ad": "Proje 2",
     ...
     "basvuru_acik": False,
     "detay": "Proje 2 için detaylı açıklamalar burada yer alır."},
    ...
    {"ad": "Proje 3",
     ...
     "basvuru_acik": True,
     "detay": "Proje 3 için detaylı açıklamalar burada yer alır."},
    ...
    {"ad": "Proje 4",
     ...
     "basvuru_acik": False,
     "detay": "Proje 4 için detaylı açıklamalar burada yer alır."},
    ...
    {"ad": "Proje 5",
     ...
     "basvuru_acik": True,
     "detay": "Proje 5 için detaylı açıklamalar burada yer alır."},
    ...
    {"ad": "Proje 6",
     ...
     "basvuru_acik": True,
     "detay": "Proje 6 için detaylı açıklamalar burada yer alır."},
    ...
    {"ad": "Proje 7",
     ...
     "basvuru_acik": False,
     "detay": "Proje 7 için detaylı açıklamalar burada yer alır."},
    ...
    {"ad": "Proje 8",
     ...
     "basvuru_acik": False,
     "detay": "Proje 8 için detaylı açıklamalar burada yer alır."},
    ...
    {"ad": "Proje 9",
     ...
     "basvuru_acik": True,
     "detay": "Proje 9 için detaylı açıklamalar burada yer alır."},
    ...
    {"ad": "Proje 10",
     ...
     "basvuru_acik": False,
     "detay": "Proje 10 için detaylı açıklamalar burada yer alır."}
]
            ...
            with col2:
                ...
                with col4:
                    with st.expander(f"Detaylar - {item['ad']}"):
                        st.write(item["detay"])  # Burada detay verisini gösteriyoruz.
                with col5:
